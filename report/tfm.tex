...
\newcommand*{\plogo}{\includegraphics[scale=.3]{unizar.png}} % Generic publisher logo
...
{\LARGE M\'aster en Modelizaci\'on e Investigaci\'on  \\[0.3\baselineskip] Matem\'atica, Estad\'istica y Computaci\'on}\\[0.2\baselineskip] % Title
...
Identificaci\'on de patrones y algoritmos de consolidaci\'on en bases de datos de posicionamiento\\[\baselineskip] % Tagline(s) or further description
...
\bibitem{r} \label{r} \textsc{R} \\ \url{https://www.r-project.org/}

\bibitem{creative} \label{creative} \textsc{Creative Commons License} \\ \url{https://creativecommons.org/licenses/by-nc-sa/4.0/}
\end{thebibliography}

...
\renewcommand{\listfigurename}{Lista de tablas y figuras}
...
En los pr\'oximos resultados utilizaremos una implementaci\'on en Weka para lanzar un estudio, sin embargo, se ha desarrollado en Python el algoritmo de \textbf{DJ-Cl\'uster} de manera parecida al de \textbf{DBSCAN}. Se puede consultar una implementaci\'on en el anexo \ref{App:AppendixF}.
...
Haciendo un peque\~no cambio en el c\'odigo que podemos encontrar de la implementaci\'on de DBSCAN en el ap\'endice \ref{App:AppendixG}.\\
...
\begin{figure}[H]
	...
	\hline
		...
		\begin{tabular}{l l}
			...
			Tiempo de ejecuci\'on & 0.03 secs
		\end{tabular} & 
		\begin{tabular}{l l}
			Canopy: & S\'i \\
			Iteraciones: & 12\\
			...
			Tiempo de ejecuci\'on & 1.56 secs
		\end{tabular}\\
		\hline
...
\newpage
\section{Impementaci\'on de DBSCAN en Python} \label{App:AppendixG}

...
\EndFunction
\end{algorithmic}
\caption{\label{alg:seeifrelin} Algoritmo de consolidaci\'on simple}
\end{algorithm}
...
\EndFunction
\end{algorithmic}
\caption{\label{alg:seeifrelin} Algoritmo de consolidaci\'on cada cierto n\'umero}
\end{algorithm}
...
\newpage
\section{Impementaci\'on de consolidaci\'on por tiempo} \label{App:AppendixA}

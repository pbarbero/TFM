...
\item número de posiciones que ha agrupado por clúster entre 1 y 9
\end{itemize}
...
\begin{frame}[fragile]
\frametitle{DBSCAN}
\textbf{DBSCAN}  es un algoritmo de clustering basado en la densidad por lo que encuentra el número de clústers comenzando por una estimación de la distribución

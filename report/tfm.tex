...
library(xtable)
valuesBahia <- data.frame(x=dataBahia)
xtable(summary(valuesBahia))
\end{lstlisting}
...
\begin{figure}[H]
	...
	\hline
		...
		\begin{tabular}{l l}
			...
			Tiempo de ejecuci\'on & 0.69 secs
		\end{tabular} &
		\begin{tabular}{l l}
			Canopy & S\'i\\
			N. Cl\'usters & 500 \\
...
Quedar\'ia como trabajo a futuro la inserci\'on de la velocidad en los algoritmos de \textbf{K-means}, \textbf{DJ-Cluster} y \textbf{DBSCAN}. La definici\'on de un nuevo concepto de diccionario ha sido realizada para los algoritmos de consolidaci\'on simple, sin embargo, la realizaci\'on de pruebas sobre los dem\'as m\'etodos ha sido realizada con el software Weka, que no permite una utilizaci\'on de distancias personalizable. \\
